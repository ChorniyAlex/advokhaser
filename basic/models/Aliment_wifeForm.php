...
class Aliment_wifeForm extends Model
{
    public $court_region;
    public $court;
    public $username;
    ...
    {
        return [
            [['court_region', 'court', 'region_user', 'region_defendant', 'whom_alimony', 'marriage_dissolved', 'have_income_defendant'], 'safe'],
