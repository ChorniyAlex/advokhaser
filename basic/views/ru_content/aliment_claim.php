    ...
    <?php if (isset($model)) : ?>
        <div class="main-content">
            <article>
                ...
                <p>Відповідно до ст.180 СК України, батьки зобов'язані утримувати дитину до досягнення нею повноліття.</p>
                <p>Відповідно до ч.3 ст.181 СК України, за рішенням суду кошти на утримання дитини (аліменти) присуджуються у частці від доходу її матері, батька або у твердій грошовій сумі за вибором того з батьків або інших законних представників дитини, разом з яким проживає дитина.</p>
                <p>Відповідно до ч.2 ст.182 СК України, розмір аліментів має бути необхідним та достатнім для забезпечення гармонійного розвитку дитини. Мінімальний розмір аліментів на одну дитину не може бути меншим, ніж 50 відсотків прожиткового мінімуму для дитини відповідного віку.</p>
                <p>Відповідно до ч.5 ст.183 СК України той із батьків або інших законних представників дитини, разом з яким проживає дитина, має право звернутися до суду із заявою про видачу судового наказу про стягнення аліментів у розмірі на одну дитину - однієї чверті, на двох дітей - однієї третини, на трьох і більше дітей - половини заробітку (доходу) платника аліментів, але не більше десяти прожиткових мінімумів на дитину відповідного віку на кожну дитину.</p>
                <p>Відповідно до п.4 ч.1 ст.161 ЦПК України судовий наказ може бути видано, у разі якщо заявлено вимогу про стягнення аліментів у розмірі на одну дитину - однієї чверті, на двох дітей - однієї третини, на трьох і більше дітей - половини заробітку (доходу) платника аліментів, але не більше десяти прожиткових мінімумів на дитину відповідного віку на кожну дитину, якщо ця вимога не пов’язана із встановленням чи оспорюванням батьківства (материнства) та необхідністю залучення інших заінтересованих осіб.</p>
                <p>Відповідно до ч.1 ст.191 СК України аліменти на дитину присуджуються за рішенням суду від дня пред'явлення позову, а в разі подання заяви про видачу судового наказу - із дня подання такої заяви.</p>
