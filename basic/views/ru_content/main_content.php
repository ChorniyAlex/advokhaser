    ...
    <main>
        ...
        <div class="home-ekran-5">
            ...
            <div class="container-icon">
                ...
                <div class="not-animation-text">
                    <p><span class="otzivi">"Благодарю адвокатов Дашко и Ко. за принципиальную жесткость в защите моих прав, что позволило доказать мою невиновность."</span><br><br><br><br>И. Дудник, г. Северодонецк</p>
                </div>
            </div>
        </div>
