...
<div class="main-content">
    <div class="content-innovation-servis it">
        <h1>Складання заяви про встановлення факту смерті особи на непідконтрольній владі України території</h1>
        <div class="title">
            <br>
            <h2>Дійте згідно нижче розміщеним підказкам і уважно заповнюйте поля українською мовою, а також завантажте інструкцію (відкриється в новому вікні) і перейдіть назад на цю сторінку для продовження</h2>
            <br>
        ...
        <div class="home-ekran-2">
            <div class="container-icon">
                <a href="<?= Url::toRoute(['ua_content/fact_death_instruction']) ?>" target="_blank">
                    <div class="icon" title='Відкриє згенерований PDF-файл в новому вікні'><?= Html::img('@web/img/icon-5.svg', ['title' => 'Відкриє згенерований PDF-файл в новому вікні']) ?>
        ...
        <div class="main-content">
            <article>
                ...
                <ul class="spisok">
                    ...
                    <li>Своє свідоцтво про народження та інші документи, які підтверджують рідство з померлою особою</li>
