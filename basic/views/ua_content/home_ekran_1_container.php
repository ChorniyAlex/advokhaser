        ...
        <div class="innovation-head">
            ...
            <div class="innovation-content">
                <a href="<?= Url::toRoute(['ua_content/innovation']) ?>" target="_blank">
                    ...
                    <p class="innovation-photo-text">Всього кілька кліків дозволять вам: скористуватися нашою унікальною IT-технологією і легко скласти заяву про розірвання шлюбу, про стягнення аліментів...</p>
                </a>
            </div>
            <a class="btn" href="<?= Url::toRoute(['ua_content/innovation']) ?>" target="_blank">Скласти заяву</a>
        </div>
        <div id="epigraf">
            <p class="epigraph-text">"Своєчасне звернення до адвоката вирішить Ваші проблеми швидче, дешевше, і допоможе уникнути зайвого ускладнення справи"</p>
        </div>
    </section>
</div>