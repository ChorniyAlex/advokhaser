...
<div class="main-content">
    <article>
        ...
        <p class="content-text">Адвокатська компанія Дашко & Ко. – це команда досвідчених адвокатів, які люблять свою
            справу. Надаємо юридичну допомогу своїм клієнтам вже понад 20 років: захист і представництво в судах
            всіх інстанцій, в правоохоронних органах, а також складання позовних заяв, скарг, договорів та
            інших документів. Підберемо найбільш оптимальний і відповідний спосіб і стратегію захисту Ваших прав та
            інтересів.</p>
        <br>
        <div><?= Html::img('@web/img/photo-dashko.JPG', ['class' => 'content-photo', 'alt' => 'photo-dashko']) ?>
            <p class="content-photo-text">Керуючий партнер, Адвокат<br>Член дисциплінарної комісії адвокатури Луганьскої області<br>Досвід роботи в юриспруденції: з 1991 р.</p>
        </div>
