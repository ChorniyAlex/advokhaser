...
<div class="main-content">
    <article>
        ...
        <p class="content-text">Ми здійснюємо представництво інтересів фізичних та юридичних осіб в судах при здійсненні цивільного, господарського, адміністративного та конституційного судочинства, а також в інших державних органах, перед фізичними та юридичними особами.</p>
        <p class="content-text">Також можемо представляти інтереси потерпілого при розгляді справи про адміністративне правопорушення, прав і обов'язків потерпілого, цивільного позивача, цивільного відповідача у кримінальному провадженні.</p>
